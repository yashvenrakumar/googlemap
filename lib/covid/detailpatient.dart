...
class Detail extends StatefulWidget {
  ...
  String pin;
  Detail(
      this.img, this.add, this.des, this.cood, this.name, this.age, this.pin);
...
class _DetailState extends State<Detail> with SingleTickerProviderStateMixin {
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                _buildMenuItem(" Address s ", active: true),
                                _buildMenuItem("Description : ${widget.des}"),
  ...
  _build3dObject() => Positioned(
        ...
        bottom: 0.29 * _screen.height,
        left: _maxSlide - _screen.width * 0.4,
